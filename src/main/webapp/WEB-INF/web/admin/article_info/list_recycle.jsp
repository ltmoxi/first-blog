                            ...
                            <table id="table" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${pageInfo}" var="entity" varStatus="status">
                                    <tr data-id="${entity.id}">
                                        ...
                                        <td>
                                            <button type="button" data-type="restore" class="btn btn-success btn-group-justified">
                                                还原
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" data-type="remove"
                                                    class="btn btn-danger btn-group-justified">彻底删除
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function remove(el) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/article_info/delete.json",
                type: "POST",
                dataType: "json",
                data: data,
                success: function (result) {
                    ...
                    if (result.code === 2000) {
                        ...
                        window.location.href = "${pageContext.request.contextPath}/admin/article_info/list_recycle.action";
                    } else {

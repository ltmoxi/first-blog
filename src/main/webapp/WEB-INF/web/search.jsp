...
<head>
    ...
    <script>
        ...
        function showArticle() {
            $("#content").empty();
            const url = "${pageContext.request.contextPath}/portal/search.json?pageNum=${pageNum}&typeId=${typeId}&keyWord=${keyWord}";
            $.ajax({
                "url": url,
                "type": "GET",
                "dataType": "json",
...
<div class="row clearfix">
    <div class="col-md-12 column" style="height: 120px;">
        <h2 id="heading" style="text-align: center;">搜索关键字:${keyWord}</h2>
    </div>
</div>

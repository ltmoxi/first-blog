			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
					<div class="content-header">
						...
						<span class="active"><a href="${pageContext.request.contextPath}/portal/type.action?typeId=${article.typeId}">${articleInfo.name}</a></span>
						<span class="divider">/</span>
...
<script>
	$(document).ready(function() {
		...
		$(".header").css("background-image", "url(${article.cover})");

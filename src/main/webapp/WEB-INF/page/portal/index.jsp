                ...
                <c:forEach items="${pageInfo.list}" var="entity" varStatus="status">
                    <div class="block block2">
                        <div class="grid-5-7" style="height: 250px;">
                            ...
                            <div class="main-15">
                                <h4>
                                    <a href="${pageContext.request.contextPath}/portal/type.action?typeId=${entity.typeId}">${entity.name}</a>
                                </h4>
                                <h2>
                                    <a href="${pageContext.request.contextPath}/portal/article.action?id=${entity.id}"><b>${entity.title}</b></a>
                                </h2>
                                <p>
                                        ${entity.summary}

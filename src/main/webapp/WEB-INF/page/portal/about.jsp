			...
			<div class="grid-1-2-1">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 50px;margin-bottom: 40px;">
					...
					<div class="block block2">
						<div class="main-0">
							<p>2018-02-21：</p>
							<blockquote><p>但事实上，早在2008年，诺兰执导的《蝙蝠侠：黑暗骑士》就已经入围了奥斯卡奖项提名。也正是因为这部电影的出现，奥斯卡才将拥挤的最佳影片提名名额开放到了10个甚至更多，来容纳更多的商业佳作。</p></blockquote>
							
							<p>2017-02-21：</p>
							<blockquote><p>在被问到“明年谁会赢？”这个问题时，诺兰半开玩笑说到，他预测《黑豹》将被提名2019年的最佳影片，它将成为第一部进军学院奖的漫改电影。</p></blockquote>
						</div>
					</div>
				</div>
				<div></div>
